...
import nether_plus.common.block.BlockModDoor;
import nether_plus.common.block.NPBlockList;

public abstract class Survival_VI_AIDoorInteract extends EntityAIBase
{
    protected EntityLiving theEntity;
    protected int entityPosX;
    protected int entityPosY;
    protected int entityPosZ;
    protected BlockModDoor field_151504_e;
    /**
    ...
    public Survival_VI_AIDoorInteract(EntityLiving par1EntityLiving)
    {
    ...
    private BlockModDoor func_151503_a(int p_151503_1_, int p_151503_2_, int p_151503_3_)
    {
        Block block = this.theEntity.worldObj.getBlock(p_151503_1_, p_151503_2_, p_151503_3_);
        return block != NPBlockList.blockGrimwoodDoor ? null : (BlockModDoor)block;
    }
}