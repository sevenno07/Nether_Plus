...
public class EntityGrimwoodArrow extends EntityArrow
{
	...
	public EntityGrimwoodArrow(World world)
	{
		super(world);
	...
	public EntityGrimwoodArrow(World world, double x, double y, double z)
	{
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	{
		if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
		{
			...
			if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(NPItemList.grimwoodArrow, 1)))
			{
				flag = false;
			}
