...
public class ItemBlockModStoneSlab extends ItemBlock
	...
	public ItemBlockModStoneSlab(Block block, BlockSlab blockSlab, BlockSlab blockSlab2, boolean b)
	{
		super(block);
	...
	{
		return ((ModStoneSlab)theHalfSlab).func_150002_b(stack.getItemDamage());
	}
