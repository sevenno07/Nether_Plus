...
public class NPRecipe
{
	public static void loadRecipe()
	{
		...
		GameRegistry.addRecipe(new ItemStack(NPBlockList.GrimwoodWorkbench, 1), new Object[]{"XX", "XX", 'X', NPBlockList.NetherPlanks, 0});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodStick, 4), new Object[]{"X", "X", 'X', NPBlockList.NetherPlanks, 0});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodSword, 1), new Object[]{"X", "X", "Y", 'X', NPBlockList.NetherPlanks, 0, 'Y', NPItemList.GrimwoodStick});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodPickaxe, 1), new Object[]{"XXX", " Y ", " Y ", 'X', NPBlockList.NetherPlanks, 0, 'Y', NPItemList.GrimwoodStick});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodAxe, 1), new Object[]{"XX ", "XY ", " Y ", 'X', NPBlockList.NetherPlanks, 0, 'Y', NPItemList.GrimwoodStick});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodShovel, 1), new Object[]{"X", "Y", "Y", 'X', NPBlockList.NetherPlanks, 0, 'Y', NPItemList.GrimwoodStick});
		GameRegistry.addRecipe(new ItemStack(NPItemList.GrimwoodHoe, 1), new Object[]{"XX ", " Y ", " Y ", 'X', NPBlockList.NetherPlanks, 0, 'Y', NPItemList.GrimwoodStick});
		...
		GameRegistry.addRecipe(new ItemStack(NPBlockList.GrimwoodChest, 1), new Object[]{"XXX", "X X", "XXX", 'X', NPBlockList.NetherPlanks, 0});
		...
		GameRegistry.addRecipe(new ItemStack(NPBlockList.ModWoodSlab, 6, 0), new Object[]{"XXX", 'X', NPBlockList.NetherPlanks, 0});
		GameRegistry.addRecipe(new ItemStack(NPBlockList.ModStoneSlab, 6, 2), new Object[]{"XXX", 'X', NPBlockList.NetherrackBrick});
		GameRegistry.addRecipe(new ItemStack(NPItemList.ItemGrimwoodDoor, 1), new Object[]{"XX", "XX", "XX", 'X', NPBlockList.NetherPlanks, 0});
