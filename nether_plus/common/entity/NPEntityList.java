...
public class NPEntityList
{
	public static void loadEntity()
	{
		...
		EntityRegistry.addSpawn(Wight.class, 100, 7, 7, EnumCreatureType.ambient, BiomeGenBase.hell);
		...
		EntityRegistry.addSpawn(Mogus.class, 1, 5, 5, EnumCreatureType.ambient, BiomeGenBase.hell);
		...
		EntityRegistry.addSpawn(RedMogus.class, 1, 5, 5, EnumCreatureType.ambient, BiomeGenBase.hell);
		...
		EntityRegistry.addSpawn(Pordenfer.class, 1, 3, 3, EnumCreatureType.ambient, BiomeGenBase.hell);
